...
const [active,setActive] =useState(false)
  ...
  return (
    <div className="text-3xl font-bold font-montserrat">
      <header className="absolute flex items-center justify-center h-20 xl:24 w-full border-b-2 border-blue-light">
        <nav className="h-full w-5/6 flex flex-row items-center lg:justify-between ">
          ...
          <ul className={`w-full lg:w-auto fex-row lg:justify-between ${active ? 'hidden' : 'flex justify-around'}`}>
            <li className="font-oswald font-extrabold text-base md:text-xl lg:text-3xl lg:mr-12 xl:mr-14 text-blue-light">
              SERVICES
            </li>
            <li className="font-oswald font-extrabold text-base md:text-xl lg:text-3xl lg:mr-12 xl:mr-14 text-blue-light">
              WORK
