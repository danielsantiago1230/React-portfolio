    ...
    <main className="w-full h-screen flex flex-row items-end justify-end">
      <div className="lg:w-full h-5/6 flex flex-col items-center justify-center">
        <div className="w-5/6 lg:w-3/6 h-5/6 flex flex-col items-start">
          <div className="bg-green-light h-2 w-2/6 lg:w-1/6" />
          <h1 className="font-oswald font-extrabold text-2xl lg:text-4xl xl:text-5xl text-green-semi-dark">
            I'M  SANTIAGO QUINTERO ARIZA <br/>FRONT-END DEVELOPER
          </h1>
          <p className="font-oswald font-extrabold text-1xl lg:text-1xl xl:text-2xl text-green-light">
          ...
          <button className="w-auto">
            <img src={start} alt="button-start" className='w-20 lg:w-28' />
          </button>
        </div>
